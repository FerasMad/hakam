    ...
    def __init__(self, backbone_key: str, tasks: list[str], freeze_blocks: int,
        ...
        if pretrained:
            ...
            if backbone_key in {"videomae_base", "videomae_base_ssv2"}:
                ...
                # architecture. Keeping the architecture local makes final.pt
                # independently loadable; strict load_state_dict below remains
                # the guard against any checkpoint/config incompatibility.
